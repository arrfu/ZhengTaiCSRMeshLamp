...
#import "LXSceneTableCell.h"

@interface LXSceneTableCell(){
    UIView *bgView;
    UILabel *titleLabel;
    UIButton *editButton;
    UIButton *_stateIcon;
...
@implementation LXSceneTableCell
...
-(void)addCellUI{
    // 背景
    bgView = [[UIView alloc] initWithFrame:CGRectMake(10, 0, kScreenWidth-20, LXSceneTableCellHeight)];
    ...
    // line
    UIView *line1 = [[UIView alloc] initWithFrame:CGRectMake(10, (bgView.jf_height-1), bgView.jf_width-20, 1)];
